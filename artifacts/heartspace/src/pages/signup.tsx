    ...
    >
      ...
      <div className="w-full max-w-[420px] z-10">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-3 mb-2">
            <svg width="28" height="26" viewBox="0 0 22 20" fill="none">
              <path d="M11 18.5C11 18.5 1.5 12.5 1.5 6.5C1.5 4.01 3.51 2 6 2C8 2 9.75 3.1 11 4.75C12.25 3.1 14 2 16 2C18.49 2 20.5 4.01 20.5 6.5C20.5 12.5 11 18.5 11 18.5Z" stroke={GOLD} strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: MUTED }}>Join HeartSpace as a student</p>

          {success ? (
            <div className="text-center py-6">
              <div className="text-4xl mb-3">✉️</div>
              <p className="font-semibold mb-1" style={{ color: SIDEBAR }}>Check your inbox!</p>
              <p className="text-sm mb-5" style={{ color: MUTED }}>
                We sent a confirmation link to <strong>{form.getValues("email")}</strong>.<br />
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-semibold" style={{ color: SIDEBAR }}>Full name</FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-semibold" style={{ color: SIDEBAR }}>Email</FormLabel>
                      <FormControl>
                        <Input
                          type="email"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-semibold" style={{ color: SIDEBAR }}>Password</FormLabel>
                      <FormControl>
                        <Input
                          type="password"
